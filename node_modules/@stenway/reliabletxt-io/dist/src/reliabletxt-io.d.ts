...
export declare abstract class ReliableTxtFile {
    ...
    static appendAllTextSync(content: string, filePath: string, createWithEncoding?: ReliableTxtEncoding, prependLineBreakIfNotEmpty?: boolean): void;
    static appendAllText(content: string, filePath: string, createWithEncoding?: ReliableTxtEncoding, prependLineBreakIfNotEmpty?: boolean): Promise<void>;
